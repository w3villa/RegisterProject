...
<form action="${pageContext.servletContext.contextPath}/login" style="padding:0px; margin:0px;" >
	<div style=" padding: 0 0 0 44px;"><input type="submit" class="button" value="Continue" /></div>
</form>
