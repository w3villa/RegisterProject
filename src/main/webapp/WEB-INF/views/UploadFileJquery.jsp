...
<link rel="stylesheet" href="resources/css/jquery-file-upload/jquery.fileupload-ui.css">
...
<div class="container">
    ...
    <form id="fileupload" action="${pageContext.servletContext.contextPath}/FileUploadAmazonTemp/" method="POST" enctype="multipart/form-data">
...
<script src="resources/js/jquery-file-upload/locale.js"></script>
